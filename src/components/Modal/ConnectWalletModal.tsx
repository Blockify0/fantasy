...
const ConnectWalletModal = memo(({ isOpen, onClose }: ConnectWalletModalProps) => {
  ...
  const handleNeedWalletModalClose = () => {
          ...
          <div className="space-y-3">
            {walletOptions.map((wallet) => (
              <button
                ...
                className="w-full flex justify-between items-center text-white bg-custom-red min-w-[140px] font-normal rounded-[16px] py-3 px-4 border-[3px] border-black hover:bg-opacity-90 transition-colors"
              >
